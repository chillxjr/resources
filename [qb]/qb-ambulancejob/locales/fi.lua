local Translations = {
    ...
    mail = {
        ...
        message = 'Hyvä %{gender} %{lastname}, <br /><br /> Viimeisimmän sairaalakäynnin hoidon lasku on nyt annettu teille.<br /> Laskun summaksi tuli: <strong>%{costs}€</strong><br /><br />Toivomme Teille pikaista paranemista! <br /> Ystävällisin terveisin, <br /> Töölön sairaalan henkilökunta '
    },
    states = {
        irritated = 'ärtynyt',
