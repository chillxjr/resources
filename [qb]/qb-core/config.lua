...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = {['cash'] = 0, ['bank'] = 0, ['crypto'] = 0} -- ['type'] = startamount - Add or remove money types for your server (for ex. ['blackmoney'] = 0), remember once added it will not be removed from the database!
...
QBConfig.Player = {}
QBConfig.Player.MaxWeight = 400000 -- Max weight a player can carry (currently 120kg, written in grams)
...
QBConfig.Server.Discord = "https://discord.gg/CuuCcx5K" -- Discord invite link
