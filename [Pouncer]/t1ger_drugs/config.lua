...
Config = {
    ...
    DrugSale = {
        ...
        amount = {
            ...
            max         = 50            -- max amount of drugs to sell (only if item.count allows it of course)
        },
        max_cap         = 0,          -- max amount of drugs to be sold per server restart per player, to disable set to 0.
...
Config.DrugJobs = {
    ...
    NPC = {
        ...
        name        = 'T1GER#9080',                     -- NPC name/number (if using phone msg)
...
Config.Shells = {
    ...
    ['coke2'] = {prop = GetHashKey('shell_coke2'), type = 'coke'},
    ['meth2'] = {prop = GetHashKey('shell_meth'), type = 'meth'},
    ['weed2'] = {prop = GetHashKey('shell_weed2'), type = 'weed'},
}
...
Config.Blips = {
    -- npc ped job blip:
    ['npc'] = {enable = true, sprite = 280, color = 5, scale = 0.8, label = Lang['npc_blip'], display = 4},
    -- job vehicle blip:
    ['job'] = {enable = true, sprite = 1, color = 5, scale = 0.65, label = Lang['drug_blip'], display = 4, route = true},
    -- job delivery blip:
    ['delivery'] = {enable = true, sprite = 1, color = 5, scale = 0.75, label = Lang['delivery_blip'], display = 4, route = true},
    -- police alert blip on map
    ['police'] = {show = true, time = 20, radius = 50, alpha = 250, color = 3},
    -- coke lab blip:
    ['coke'] = {enable = true, sprite = 51, color = 0, scale = 0.75, label = Lang['coke_lab'], display = 4},
    -- meth lab blip:
    ['meth'] = {enable = true, sprite = 51, color = 54, scale = 0.75, label = Lang['meth_lab'], display = 4},
    -- weed lab blip:
    ['weed'] = {enable = true, sprite = 51, color = 25, scale = 0.75, label = Lang['weed_lab'], display = 4},
}
